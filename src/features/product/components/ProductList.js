...
const filters = [
  {
    ...
    options:[
      ...
      { value: "budget", label: "Budget Phones", checked: false },
      { value: "camera", label: "Camera Centric", checked: false },
      { value: "gaming", label: "Gaming Phones", checked: false },
      { value: "retro-design", label: "Retro Design", checked: false }
    ],
  },
  {
    id: "color",
...
//if we check inside the console we are able to see what we are selecting in 
//the categories and based on that we can call our api based onntheir id and all now 
//we have to create an api based on this filter 
                    ...
                    <div className="py-1">
                      {sortOptions.map((option) => (
                        <Menu.Item key={option.name}>
                          {({ active }) => (
                            <p
                          //  we are using it to check the data inside the console
                        /*      onClick={e=>console.log(option)} */ 
                        onClick={(e)=>handleSort(e,option)}
                           //  onClick={(e)=>console.log(option.sort,option.order)}
                          ...
                          {products && products.map((product) => (
                            <div key={product.id} className="group relative">
                              ...
                              <div className="mt-4 flex justify-between">
                                ...
                                <p className="text-sm font-medium   text-gray-900"><ShoppingBagIcon/>
                                  {product.rating}
                                </p>
